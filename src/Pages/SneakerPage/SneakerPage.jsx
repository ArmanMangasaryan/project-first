...
const SneakerPage = () => {
    ...
    const sneakersData = useSelector(selectSneakers)

    const sneaker = sneakersData.data[id]
            ...
            <section className={productPageStyle.productPageSection}>
                <div className="container">
                    <div className={productPageStyle.productParentDiv}>
                        ...
                        <h1 className={productPageStyle.productName}>КРОСОВКИ {sneaker?.description}</h1>
                ...
                <Routes>
                    <Route path="/" element={<ProductLayOut />}>
                        <Route index element={<AboutSneaker sneaker={sneaker} />} />
